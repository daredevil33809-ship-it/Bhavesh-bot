...
async def add_user(user_id: int, username: str = None, first_name: str = None):
    # This function involves I/O (saving users), so run it in a thread
    await asyncio.to_thread(_add_user_sync, user_id, username, first_name)
    
def _add_user_sync(user_id: int, username: str = None, first_name: str = None):
