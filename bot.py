...
# FIX: Removing explicit ClientSession handling to prevent loop conflicts with gevent/gunicorn
bot = Bot(
    token=BOT_TOKEN, 
...
# --- Blocking I/O Functions (Synchronous Versions) ---
...
# We use asyncio.to_thread for safety when calling these blocking I/O functions
...
async def cmd_start(message: Message):
    if message.from_user:
        ...
        # For simplicity, keeping sync function calls outside heavy async contexts.
        pass
...
async def cmd_refresh(message: Message):
    ...
    # Using the async wrapper for blocking file I/O
    await load_movies()
